...
const getSuggestionValue = suggestion => {
  ...
  const value = coderegex.exec(suggestion)
  return value[0]
}
...
export class CodeChildSearch extends Component {
  constructor(props) {
    super(props)
  ...
  onSelection = (event, selection) => {
    this.props.select(selection.suggestionValue)
    console.log(`onSeslection ${JSON.stringify(selection)}`)
  }
...
export default CodeChildSearch
